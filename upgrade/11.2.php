...
msgbox("info","Information", "Database update from version <b>11.2</b> to version <b>11.3</b> has been completed successfully.<br /><br />{$error_info}<br />Click Next to continue the update process.");
