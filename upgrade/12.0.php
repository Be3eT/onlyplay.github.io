...
msgbox("info","Information", "Database update from version <b>12.0</b> to version <b>12.1</b> has been completed successfully.<br /><br />{$error_info}<br />Click Next to continue the update process.");
